...
public class UIUtils {
    ...
    public static final String BUTTON_TEXT_LOGIN = "Se connecter";
    public static final String BUTTON_TEXT_RESTART = "Recommencer";
    ...
    public static final String PLACEHOLDER_TEXT_USERNAME = "Nom Utilisateur";
    public static final String PLACEHOLDER_TEXT_UNIVERSITE = "Université d'Origine";
    public static final String BUTTON_TEXT_START = "Commencer";
